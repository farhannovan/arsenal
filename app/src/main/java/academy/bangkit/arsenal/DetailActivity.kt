...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnShare.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, "Wow! ${playerData.name} will be playing as starter on the upcoming Arsenal match! Can't wait to see him live with his number ${playerData.number}!")
